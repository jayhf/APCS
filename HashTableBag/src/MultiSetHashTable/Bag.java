...
public interface Bag<E> extends Iterable<E>
{
     ...
     * @throws IllegalArgumentException if count == Integer.MAX_VALUE
     ...
     */
      ...
      * 
      * @param elem the element to add
      * @param occurrences the number of times to put elem in the bag
      * @throws NullPointerException if elem == null
      * @throws IllegalArgumentException if occurrences < 0 or adding will result in more than Integer.MAX_VALUE
      * @returns the count before the add -- possibly 0
      */
      ...
      * The iterator will return multiple occurrences of items as indicated by count
      * No particular ordering of the elements is guaranteed, unless the implementation
      * does this.
      ...
      * @param elem the element to remove a single item of
      * @return true if elem is found and removed
      */
     boolean remove (E elem);
     /**
      * remove a number of occurrences, if occurrences > count then all are removed.
      * @param occurrences the number of elem to remove, may be 0
      * @param elem the element to be removed
      * @throws IllegalArgumentException if occurrences < 0
      ...
      * @throws NullPointerException if elem == null
      * @param elem the item to add/remove up to count
      * @param count the desired count for element elem
