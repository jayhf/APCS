 ...
 * 
 * April 2011 Modified by J. Smith - improved variable names, structure
 * 
 * May 2013
 * 
 *************************************************************************/
...
public class Dungeon {
	...
	// can move diagonally only room to room - Jay
	// does v-w correspond to a legal move?
	// Jsmith: Why isn't a corridor a legal move? ok -- caught by last two if's
	// error; revealed by dungeonP,
	// . +
	// + . should NOT be legal to move on diagonal
